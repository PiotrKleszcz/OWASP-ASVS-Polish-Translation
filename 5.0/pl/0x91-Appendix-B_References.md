...
## Projekt OWASP Cheat Sheet Series

[Projekt ten](https://owasp.org/www-project-cheat-sheets/) zawiera wiele ściąg przydatnych przy różnych tematach ASVS.

Mapowanie do ASVS można znaleźć tutaj: [https://cheatsheetseries.owasp.org/IndexASVS.html](https://cheatsheetseries.owasp.org/IndexASVS.html)

## Projekty związane z bezpieczeństwem mobilnym
...
3. OWASP Mobile Security Testing Guide oraz Mobile Application Security Verification Standard: [https://owasp.org/www-project-mobile-security-testing-guide/](https://owasp.org/www-project-mobile-security-testing-guide/)

## Projekty OWASP związane z Internetem rzeczy
...
## Projekty OWASP dotyczące serverless
