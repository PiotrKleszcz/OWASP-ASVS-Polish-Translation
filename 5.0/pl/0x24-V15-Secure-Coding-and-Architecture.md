...
| **15.3.3** | Zweryfikuj, że aplikacja posiada środki zaradcze chroniące przed atakami mass assignment poprzez ograniczanie dozwolonych pól per kontroler i akcja — np. nie jest możliwe wstawienie lub aktualizacja wartości pola, które nie miało być częścią danej akcji. | 2 |
